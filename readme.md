...
This package provides you with a simple tool to make laravel command set up a new package and it will let you focus on the development of the package instead of the boilerplate.
